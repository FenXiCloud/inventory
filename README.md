...
## 系统演示
- Admin管理后台：jadmin.fenxi365.com
  - 账号：13944878765 /878765
- merchant商户后台：jxc.fenxi365.com
  - 账号：13944878765 / 878765
...
纷析云进销存ERP欢迎任何人添砖加瓦，贡献代码，提交的pr（pull request）需要符合一些规范，规范如下：

1. 注释完备，尤其每个新增的方法应按照Java文档规范标明方法说明、参数说明、返回值说明等信息，必要时请添加单元测试，如果愿意，也可以加上你的大名。
2. 纷析云进销存ERP默认IDEA（tab）缩进
3. 请pull request到`develop`分支,其他分支不允许更新和提交pr。
