      ...
      nextTick(function() {
        setTimeout(function() {
          ...
          if (!((_notifyRef$value = notifyRef.value) !== null && _notifyRef$value !== void 0 && (_notifyRef$value$pare = _notifyRef$value.parentElement) !== null && _notifyRef$value$pare !== void 0 && _notifyRef$value$pare.parentElement))
            return;
          addClass((_notifyRef$value2 = notifyRef.value) === null || _notifyRef$value2 === void 0 ? void 0 : (_notifyRef$value2$par = _notifyRef$value2.parentElement) === null || _notifyRef$value2$par === void 0 ? void 0 : _notifyRef$value2$par.parentElement, "layui-layer-notify");
        }, 300);
      });
    });
    return function(_ctx, _cache) {
...
var _sfc_main = defineComponent(_objectSpread$1(_objectSpread$1({}, __default__), {}, {
  ...
  setup: function setup7(__props, _ref) {
    ...
    var boxClasses = computed(function() {
      return [type === 0 ? "layui-layer-dialog" : "", type === 1 ? "layui-layer-page" : "", type === 2 ? "layui-layer-iframe" : "", type === 3 ? "layui-layer-loading" : "", type === 4 ? "layui-layer-drawer" : "", type === 5 ? "layui-layer-photos" : "", type === 6 ? "layui-layer-notifiy-border" : "", props.isMessage ? "layui-layer-msg" : "", props.isMessage && !props.icon ? "layui-layer-hui" : "", props.skin];
    });
