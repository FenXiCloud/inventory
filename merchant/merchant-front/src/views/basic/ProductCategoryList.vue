<template>
  <div class="simple-page">
    <div class="simple-page__toolbar">
      <t-space break-line>
        <t-button v-auth="'productCategory:edit'" theme="primary" style="border-radius: 4px" @click="showForm()">新 增</t-button>
        <t-input
            v-model="params.name"
            clearable
    ...
    <div class="simple-page__table">
      ...
      >
        <template #ops="{ row }">
          <t-space size="small">
            <t-link v-auth="'productCategory:edit'" theme="primary" @click="showForm(null, row)">下级</t-link>
            <t-link v-auth="'productCategory:edit'" theme="primary" @click="showForm(row)"><t-icon name="edit"/></t-link>
            <t-link v-auth="'productCategory:delete'" theme="primary" @click="doRemove(row)"><t-icon name="delete"/></t-link>
          </t-space>
        </template>
