  ...
  <div class="frame-page flex flex-column">
    ...
    <div class="flex1">
      <vxe-table row-id="id"
        ...
        <vxe-column title="货商编码" field="code" width="150"/>
        <vxe-column title="货商名称" field="name"/>
        <vxe-column title="期初余额" field="amount"/>
...
export default {
  ...
  methods: {
    ...
    loadList() {
      this.loading = true;
      SupplierInitial.list(this.params).then(({data}) => {
        this.dataList = data;
