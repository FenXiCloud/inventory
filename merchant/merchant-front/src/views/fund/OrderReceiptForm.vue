  ...
  computed: {
    ...
    collectionColumns() {
      return [
        ...
        { colKey: 'amount', title: '*收款金额', width: 140, align: 'right' },
    ...
    itemColumns() {
      return [
        ...
        { colKey: 'salesOrderNo', title: '源单编号', minWidth: 140 },
  ...
  methods: {
    doPrint() {
      ...
      openPrint('收款单', {
        header: {
          ...this.form,
          partner: this.form.customerName || '',
    ...
    loadList() {
      this.loading = true;
      OrderReceipt.load(this.orderId )
