  ...
  <div class="frame-page flex flex-column">
    ...
    <vxe-toolbar>
      <template #buttons>
        ...
        <!-- <div class="h-input-group">
          <span class="h-input-addon ml-8px">付款到期日</span>
          <DatePicker
            class="w-120px"
    ...
    <div class="flex1">
      ...
      >
        ...
        <vxe-column field="accountTypeName" title="支出类别" :edit-render="{}">
          <template #header>
      ...
      <template #buttons>
        <div class="filler-panel">
          <div class="filler-item" style="flex: 1; margin: 5px 0 !important">
            ...
            <label class="ml-10px w-90px">付款金额:</label>
            <Input
...
export default {
  ...
  methods: {
    ...
    loadList() {
      this.loading = true;
      OtherExpense.details({ id: this.orderId })
