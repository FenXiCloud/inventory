<template>
  <div class="modal-column">
    <div class="modal-column-full-body">
      ...
      <div class="filler-panel">
        <div class="filler-item" style="flex: 1;margin: 5px 0px!important;">
          ...
          <a class="text-hover" href="/import/sales_order.xlsx" :download="`销售订单导入模版.xlsx`">销售订单导入模版</a>
        </div>
      </div>
      <div class="filler-panel">
        <div class="filler-item" style="flex: 1;margin: 5px 0px!important;">
    ...
    <div class="modal-column-between">
      ...
      <t-button theme="primary" :disabled="!file" v-auth="'salesOrder:edit'" @click="importData" :loading="loading">导 入</t-button>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    importData() {
      if (this.file) {
        ...
        SalesOrder.importData(formData).then(() => {
