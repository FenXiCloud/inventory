  ...
  <div class="modal-column">
    <div class="modal-column-full-body">
      <div class="import-explain">
        <h6>导入说明：</h6>
        <p>1. 每行数据生成一张独立的销售出库单（含一个商品明细）</p>
      ...
      <div class="filler-panel">
        <div class="filler-item" style="flex: 1;margin: 5px 0px!important;">
          ...
          <a class="text-hover" href="/import/sales_outbound.xlsx" :download="`销售出库单导入模版.xlsx`">销售出库单导入模版</a>
        </div>
      </div>
      <div class="filler-panel">
        <div class="filler-item" style="flex: 1;margin: 5px 0px!important;">
    ...
    <div class="modal-column-between">
      ...
      <t-button theme="primary" :disabled="!file" v-auth="'salesOutbound:edit'" @click="importData" :loading="loading">导 入</t-button>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    importData() {
      if (this.file) {
        ...
        SalesOutbound.importData(formData).then(() => {
